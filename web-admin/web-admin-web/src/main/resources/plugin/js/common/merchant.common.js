...
(function (win) {
    ...
    /**
     * 异步请求对象
     * @type {{get: honglu.ajax.get, post: honglu.ajax.post, put: honglu.ajax.put, delete: honglu.ajax.delete, ajax: honglu.ajax.ajax}}
     */
    honglu.ajax = {
        ...
        ajax: function (param) {
            if (honglu.stringUtil.isEmpty(param.url)) {
                honglu.dialog.alert("param.url不可为空");
                return false;
            }
            if (honglu.stringUtil.isEmpty(param.type)) {
                honglu.dialog.alert("param.type不可为空");
                return false;
            }
            $.ajax({
                url: param.url,
    ...
    /**
     * 字符串工具类
     * @type {{isEmpty: honglu.stringUtil.isEmpty, trim: (function(*): *)}}
     */
    honglu.stringUtil = {
        /**
         * 判断字符串是否为空
        ...
        isEmpty: function (str) {
            ...
            str = honglu.stringUtil.trim(str);
            return str.length == 0;
        },
        /**
         * 去除左右两头的空格
    ...
    honglu.forEach = function (obj, forEachCallback) {
