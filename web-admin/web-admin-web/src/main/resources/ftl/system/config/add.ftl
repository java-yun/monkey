    ...
    <form class="layui-form layui-form-pane" style="margin-left: 20px;">
        <div style="width:100%;height:500px;">
            ...
            <div style="margin-left:15%">
				...
				<input type="hidden" name="bizType" value="${bizType}" id="bizType"/>
                <div class="layui-form-item">
                    <label for="name" class="layui-form-label">
                        <span class="x-red">*</span>&nbsp;大类名称
                    </label>
                    <div class="layui-input-inline" style="width: 65%">
                        <input type="text" id="configName" name="configName" lay-verify="required" autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="name" class="layui-form-label">
...
<script type="text/javascript" src="${re.contextPath}/plugin/js/system/config/add.js "charset="utf-8"></script>
