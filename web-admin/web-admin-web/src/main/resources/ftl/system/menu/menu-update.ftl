            ...
            <div style="margin-left:25%">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block" style="width:190px;">
                        <#if sysMenu.menuType=='0'>
                            <input type="text" id="menuType" data-type="0" disabled value="菜单" class="layui-input">
                        </#if>
                        <#if sysMenu.menuType=='1'>
                            <input type="text" id="menuType" data-type="1" disabled value="按钮" class="layui-input">
                        </#if>
                ...
                <div class="layui-form-item" id="pDiv">
                    ...
                    <div class="layui-input-inline">
                        ...
                        <#--保留 但不做更新-->
                        <input type="text" id="pName" disabled value="${pName}" lay-verify="pName" class="layui-input">
                        <input type="hidden" name="code" value="${sysMenu.code}">
                        <input type="hidden" name="pCode" value="${sysMenu.PCode}">
                    </div>
...
<script>
    layui.use(['form', 'layer'], function () {
        ...
        form.on('submit(add)', function (data) {
            ...
            data.field['menuType'] = $('#menuType').data('type');
            $.ajax({
                url: 'updateMenu',
                type: 'post',
                data: data.field,
