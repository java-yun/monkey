...
<div class="lenos-search">
    <div class="select">
        ...
        <div class="layui-inline">
            <input class="layui-input" style="height:38px; width:200px" id="name" autocomplete="off" placeholder="支持模糊查询">
        </div>
       		 类型：
        <div class="layui-inline">
	...
	var layer;
  	...
  	var layout = [
      	...
      	},
    	{
      		...
      		style: 'width: 20%',
      		render: function(row) {
        		var chil_len=row.children == null?0:row.children.length;
        		var str= '<@shiro.hasPermission name="menu:edit">' +
